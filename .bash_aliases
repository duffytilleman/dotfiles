...
alias git-update-remotes='echo "# Do not edit this file. Edit .gitconfig_base instead" > ~/.gitconfig; cat ~/.gitconfig_base >> ~/.gitconfig; /var/www/newhive/bin/get_running_webservers.py --format git >> ~/.gitconfig'
